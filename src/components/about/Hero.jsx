            ...
            <div className="container mx-auto px-4">
                <div className="relative pt-24 pb-14">
                    ...
                    <div className="relative mt-20 z-50">
                        <h1 className="font-heading text-white text-center text-4xl sm:text-5xl md:text-7xl font-bold max-w-sm sm:max-w-xl md:max-w-3xl mx-auto mb-6">Jouw partner in digitale transformatie</h1>
                        <p className="text-center w-1/2 mx-auto text-white text-lg mb-12">Wij zijn meer dan een team. We zijn jouw gids op het pad naar online succes, met een passie voor innovatie en maatwerk oplossingen die écht het verschil maken.</p>
