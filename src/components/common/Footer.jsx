      ...
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div class="max-w-3xl mx-auto">
              <a href="/" class="flex justify-center ">
                 <Image src="https://i.ibb.co/HhfN9hq/mv-1.png" alt="Vista Logo" width={80} height={60} />
              </a>
                  <ul className="text-lg flex items-center justify-center flex-col gap-7 md:flex-row md:gap-12 transition-all duration-500 py-16 border-b border-white">
                      <li><a href="#" class="text-white hover:text-white">Home</a></li>
                      <li><a href="/cases" class=" text-white hover:text-white">Cases</a></li>
                      <li><a href="/about" class=" text-white hover:text-white">Over ons</a></li>
                  ...
                  <span class="text-lg text-white text-center block">©<a href="https://pagedone.io/">Movement</a> 2024, Alle Rechten Voorbehouden.</span>
          </div>
      </div>
  </footer>
