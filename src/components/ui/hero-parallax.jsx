...
export const HeroParallax = ({
  ...
  return (
    (<div
      ref={ref}
      className="bg-gradient-to-t from-white via-purple-700 to-purple-900 h-[300vh] py-40 overflow-hidden  antialiased relative flex flex-col self-auto [perspective:1000px] [transform-style:preserve-3d]">
      <Header />
      <motion.div
        style={{
          rotateX,
