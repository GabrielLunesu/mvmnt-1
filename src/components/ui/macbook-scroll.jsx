...
export const MacbookScroll = ({
  ...
  const translate = useTransform(scrollYProgress, [0, 0.3], [0, 300]);
  const rotate = useTransform(scrollYProgress, [0, 0.3], [-28, 0]);
  const textTransform = useTransform(scrollYProgress, [0, 0.3], [0, 50]);
          ...
          {!imageError ? (
            <div className="relative w-full h-full flex items-center justify-center">
              <Image
                ...
                width={880}  // Increased from 480 to 640
                height={400} // Increased from 270 to 360, maintaining 16:9 aspect ratio
