            ...
            <>
                <section className="pt-24 pb-32 bg-gradient-to-t from-purple-900 via-purple-500 to-white">
                    <div className="container mx-auto px-4">
                        <h3 className="font-heading text-center text-4xl md:text-6xl font-bold mb-6">Groei begint hier</h3>
                        <p className="text-opacity-70 text-center text-lg mb-20 max-w-2xl mx-auto">Plan vrijblijvend een afspraak in, zodat wij je kunnen laten zien hoe een goede website meer bezoekers transformeert naar klanten.</p>
