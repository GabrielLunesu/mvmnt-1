    ...
    return (
        <section className="py-40 bg-gradient-to-b from-purple-900 via-purple-600 to-purple-900">
            <div className="container mx-auto px-4 max-w-6xl">
                <div className="bg-gradient-to-br from-pink-900 to-purple-900 rounded-3xl shadow-xl overflow-hidden">
                    <div className="flex flex-col lg:flex-row">
                        {/* Contact Information */}
                        <div className="w-full lg:w-1/2 p-12 text-white">
                            <h1 className="text-4xl font-bold mb-6">Wij staan klaar voor jou.</h1>
                            <p className="mb-8 text-purple-200">
                                Aarzel niet om contact op te nemen. Wij staan klaar om jou alle tips en tricks te geven over een hoogwaardige website.
                            </p>
                            <div className="space-y-4">
                                ...
                                <div className="flex items-center">
                                    ...
                                    <span>085-060-8991</span>
                                </div>
                                <div className="flex items-center">
                                    <svg className="w-6 h-6 mr-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" /></svg>
                                    <span><b>KVK:</b> 95329684</span>
                                </div>
                            </div>
                            <div className="mt-12">
                                <h2 className="text-xl font-semibold mb-4">Volg ons</h2>
                                <div className="flex space-x-4">
                                    <Link href="https://www.facebook.com/profile.php?id=61567458574591" className="text-white hover:text-purple-200">
                                    ...
                                    <Link href="https://www.instagram.com/mvmnt.nl/" className="text-white hover:text-purple-200">
